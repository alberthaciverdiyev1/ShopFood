<div class=" mx-auto px-24 ">
    ...
    <div class=" mt-4 flex flex-wrap gap-3">
        ...
        <div class="bg-[var(--color-warning)] rounded-2xl px-7 py-3">
            <span class="text-center text-white text-bold "> Техподдержка
            </span>

        </div>
        <div class="bg-[var(--color-warning)] rounded-2xl px-7 py-3">
            <a href="{{route('trading_rules.home')}}"> <span class="text-center text-white text-bold "> Правила торговли </span></a>
        </div>
    </div>
</div>
