...
<div id="overlay" class="fixed inset-0 bg-black/50 z-20 flex items-center justify-center hidden">
 <div id="modal" class=" bg-[#EFEFEF] fixed w-[900px] mx-auto 
    ...
    <div class="w-[45%] flex flex-col items-center">
        <div class="relative">
            <img id="modalImage" class=" bg-white px-5 py-8 rounded-xl w-130 h-90" src="{{ asset('/images/product.png') }}" alt="">
            <!-- Arrows -->
    ...
    <div class="w-[55%] flex flex-col gap-6">
        <!-- Title -->
        <h3 id="modalTitle" class="text-lg font-semibold">Zelený čaj s příchutí jahod a broskev "Tess Flirt" 25 x 1,5 g</h3>

        <!-- Price -->
        <p id="modalPrice" class="text-red-500 text-3xl font-bold">29,87</p>

        <!-- Description -->
        <p id="modalDescription" class="text-sm text-gray-700 leading-6">
            Тесс форест дрим. Чай черный байховый с ежевикой, малиной и ароматом лесных ягод...
        </p>

        <!-- Count buttons -->
        <div class="flex gap-3 mt-3">
            <button class="countBtn px-3 py-1 bg-white border-[#FC9700] border rounded-md hover:bg-gray- text-[#FC9700]" data-count="1">+1</button>
            <button class="countBtn px-3 bg-white py-1 border border-[#FC9700] rounded-md hover:bg-gray-200 text-[#FC9700]" data-count="2">+2</button>
            <button class="countBtn px-3 bg-white py-1 border border-[#FC9700] rounded-md hover:bg-gray-200 text-[#FC9700]" data-count="3">+3</button>
            <button class="countBtn px-3 bg-white py-1 border border-[#FC9700] rounded-md hover:bg-gray-200 text-[#FC9700]" data-count="4">+4</button>
            <button class="countBtn px-3 bg-white py-1 border border-[#FC9700] rounded-md hover:bg-gray-200 text-[#FC9700]" data-count="5">+5</button>
        </div>
