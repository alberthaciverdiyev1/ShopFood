...
@section('content')
    ...
    <div class="w-full min-h-screen flex items-center justify-center bg-gray-100 p-4">
        <div class="w-full max-w-6xl bg-white rounded-lg shadow-lg flex overflow-hidden">
            ...
            <div
                class="w-1/2  px-[120px] py-[100px] scroll-thin  flex flex-col justify-start max-h-screen overflow-y-auto">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <input type="text" name="reg_number" placeholder="ИНН Регистрационный номер"
                        ...
                        <div class="relative mt-2">
                            ...
                            <input type="text" name="tax_number" placeholder="ДРН (VAT) Налоговый номер"
                                   class="w-full border rounded-lg px-10 py-2 outline-none border-[#CED4DA]">
                        </div>
                        <div class="relative mt-2">
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <input type="text" name="street" placeholder="Улица, дом"
                                   class="w-full border rounded-lg px-10 py-2 outline-none border-[#CED4DA]">
                        </div>
                        <div class="relative mt-2">
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <input type="text" name="contact_name" placeholder="Имя, Фамилия"
                                   class="w-full border rounded-lg px-10 py-2 outline-none border-[#CED4DA]">
                        </div>
                        <div class="relative mt-2">
                            <i class="fas fa-phone-alt absolute left-3 top-3 text-black"></i>
