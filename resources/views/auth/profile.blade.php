...
<div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
    ...
    <div id="tab-data" class="tab-content space-y-4">
        <form class="space-y-4">
            @php
                $fields = [
                    ['label'=>'Ad Soyad', 'name'=>'name', 'value'=>$user->name, 'editable'=>true],
                    ['label'=>'Email', 'name'=>'email', 'value'=>$user->email, 'editable'=>false],
                    ['label'=>'Telefon', 'name'=>'phone', 'value'=>$user->phone, 'editable'=>true],
                    ...
                    ['label'=>'Contact Name', 'name'=>'contact_name', 'value'=>$user->contact_name, 'editable'=>true],
            ...
            <div class="relative">
                ...
                <div class="absolute right-2 top-9 flex gap-2">
                    <button type="button" onclick="enableEdit(this)" class="text-gray-400 hover:text-[#F6A833]" title="Edit">
                        <i class="far fa-edit"></i>
                    </button>
                    <button type="button" onclick="saveEdit(this)" class="hidden text-green-600 hover:text-green-800" title="Save">
                        <i class="fas fa-check"></i>
                    </button>
                    <button type="button" onclick="cancelEdit(this)" class="hidden text-red-600 hover:text-red-800" title="Cancel">
...
<div id="forgotModal" class="fixed inset-0 hidden bg-black bg-opacity-50 flex items-center justify-center">
    <div class="bg-white p-6 rounded-lg shadow-lg w-96 text-center">
        ...
        <button onclick="closeModal()" class="bg-[#F6A833] text-white px-4 py-2 rounded-md hover:bg-[#947D5B] transition">
            Bağla
        </button>
    </div>
</div>
