      ...
      <h3 class="text-[#331111] font-semibold  text-xl ">@lang("Your favorite products")</h3>
          ...
          @forelse ($favorites as $index => $item)
              <div class="favorite-row flex gap-4 justify-between items-center pb-4 mb-4">
                  ...
                  <div class="flex gap-4 items-center">
                      ...
                      <img src="{{ $item['product']['media'][0]['url']}}" alt="{{ $item['product']['name'] }}" class="w-24 h-24 object-contain mt-4">
                      <div>
                          ...
                          <p class="text-red-500 font-bold mt-2">${{ $item['product']['price_with_vat'] }}</p>
                      </div>
                  </div>

                  <div class="flex gap-4 items-center">
                      <div class="bg-white px-2 py-2 rounded-xl border border-[#FAD399] cursor-pointer remove-favorite"
                           data-product-id="{{ $item['product']['code'] }}">
          ...
          @empty
              <div class="flex flex-col items-center justify-center py-20 px-4 text-center">
                  <div class="bg-orange-100 rounded-full w-32 h-32 flex items-center justify-center mb-6">
